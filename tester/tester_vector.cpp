...
void test_vector()
{
    ...
    /* Range constructor */
    {
        std::string range_array[] = { "45", "87846", "12", "965", "5" };

        // std::vector<int>::iterator stl_iterator(&(range_array[0]));
        ft::vector<std::string>::iterator ft_iterator(&(range_array[0]));

        fs.open("./tester/vectors_output/constructor_range", std::fstream::in | std::fstream::out | std::fstream::trunc);

        std::vector<std::string> stl_range_vector(range_array, range_array + 5);
        ft::vector<std::string> ft_range_vector(ft_iterator, ft_iterator + 5);
    ...
    /* Copy constructor */
    {
        ...
        std::vector<int> stl_range_vector(range_array, range_array + 6);
    ...
    /* Operator [] */
    {
        ...
        std::vector<int> stl_operator(range_array, range_array + 5);
        ...
        fs << "¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\n";
        fs << "int range_array[] = { 8, -5615, 412, 89, 475};\n";
        fs << "std::vector<int>::iterator range_array_beg(&(range_array[0]));\n";
        fs << "std::vector<int> stl_operator(range_array_beg, range_array_beg + 5);\n";
        fs.close();
    }
    ...
    /* Normal at() */
    {
        ...
        std::vector<int> stl_at(range_array, range_array + 5);
        ...
        fs << "int range_array[] = {8, -986, -8, 66, 7};\n";
        fs << "std::vector<int>::iterator range_array_beg(&(range_array[0]));\n";
        fs << "std::vector<int> stl_at(range_array_beg, range_array_beg + 5);\n";
        fs.close();
    }    
    ...
    /* Normal front() */
    {
        ...
        std::vector<int> stl_front(range_array, range_array + 5);
        ...
        fs << "int range_array[] = {2, 0, 982, -9, 87};\n";
        fs << "std::vector<int>::iterator range_array_beg(&(range_array[0]));\n";
        fs << "std::vector<int> stl_front(range_array_beg, range_array_beg + 5);\n";
        fs.close();
    }
    ...
    /* Normal back() */
    {
        ...
        std::vector<int> stl_back(range_array, range_array + 5);
        ...
        fs << "int range_array[] = {2, 0, 982, -9, 87};\n";
        fs << "std::vector<int>::iterator range_array(&(range_array[0]));\n";
        fs << "std::vector<int> stl_back(range_array, range_array + 5);\n";
        fs.close();
    }
    ...
    /* Assign range */
    {
        ...
        stl_assign.assign(range_array , range_array + 5 );
        ...
        fs << "stl_assign.assign(range_array, range_array + 5);\n";
        fs.close();
    }
    ...
    /* Pop back */
    {
        ...
        std::vector<int> stl_popback(range_array, range_array + 5);
...
//        ft_insert.reserve(10);
    ...
    /* Insert fill */
    {
        std::string range_array[] = {"47", "152", "-325", "9", "14444"};

        // std::vector<int>::iterator range_array(&(range_array[0]));
        ft::vector<std::string>::iterator ft_iterator_beg(&(range_array[0]));
...
//        ft_insert.reserve(16);
    ...
    /* Insert range */
    {
        ...
        fs << "stl_insert.insert(stl_insert.end(), range_array, range_array + 5);\n";
        fs.close();
    }
    ...
    /* Erase single element */
    {
        ...
        std::vector<int> stl_erase(range_array, range_array + 5);
        ...
        fs << "int range_array[] = {47, 152, -325, 9, 14444};\n";
        fs << "std::vector<int>::iterator range_array(&(range_array[0]));\n";
        fs << "std::vector<int> stl_erase(range_array, range_array + 5);\n";
    ...
    /* Erase range */
    {
        ...
        stl_erase.erase(stl_erase.begin() + 1, stl_erase.end() - 1 );
        ft_erase.erase(ft_erase.begin() + 1, ft_erase.end() - 1);
    ...
    /* Swap */
    {
        ...
        std::vector<int> stl_swap_one(range_array_one, range_array_one + 5);
        std::vector<int> stl_swap_two(range_array_two, range_array_two + 5);
        ...
        fs << "int range_array_one[] = {1458, -98, 745, 62, 9};\n";
        fs << "int range_array_two[] = {478, 87, -15, 44, 7};\n";
        fs << "std::vector<int>::iterator range_array_one(&(range_array_one[0]));\n";
        fs << "std::vector<int>::iterator range_array_two(&(range_array_two[0]));\n";
        fs << "std::vector<int> stl_swap_one(range_array_one, range_array_one + 5);\n";
        fs << "std::vector<int> stl_swap_two(range_array_two, range_array_two + 5);\n";
    ...
    /* Clear */
    {
        ...
        std::vector<int> stl_clear(range_array, range_array + 5);
        ...
        fs << "int range_array[] = {-455, 2, 1347, 75, 945};\n";
        fs << "std::vector<int>::iterator range_array(&(range_array[0]));\n";
        fs << "std::vector<int> stl_clear(range_array, range_array + 5);\n";
        fs << "stl_clear.clear();\n";
        fs.close();
    }
    ...
    /* RL '==' true */
    {
        ...
        std::vector<int> stl_equal_one(range_array_one, range_array_one + 5);
        std::vector<int> stl_equal_two(range_array_two, range_array_two + 5);
        ...
        fs << "std::vector<int>::iterator range_array_one(&(range_array_one[0]));\n";
        fs << "std::vector<int>::iterator range_array_two(&(range_array_two[0]));\n";
        fs << "std::vector<int> stl_equal_one(range_array_one, range_array_one + 5);\n";
        fs << "std::vector<int> stl_equal_two(range_array_two, range_array_two + 5);\n";
        fs.close();
    }
    ...
    /* RL '!=' true */
    {
        ...
        fs << "std::vector<int>::iterator range_array_one(&(range_array_one[0]));\n";
        fs << "std::vector<int>::iterator range_array_two(&(range_array_two[0]));\n";
        fs << "std::vector<int> stl_operator_one(range_array_one, range_array_one + 5);\n";
        fs << "std::vector<int> stl_operator_two(range_array_two, range_array_two + 5);\n";
        fs.close();
    }
